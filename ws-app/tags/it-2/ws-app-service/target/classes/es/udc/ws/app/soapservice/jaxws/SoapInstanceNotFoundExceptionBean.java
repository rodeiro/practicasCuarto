 ...
 * 
 */
@XmlRootElement(name = "SoapInstanceNotFoundException", namespace = "http://soap.ws.udc.es/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "SoapInstanceNotFoundException", namespace = "http://soap.ws.udc.es/", propOrder = {
    "faultInfo",
    "message",
    "suppressed"
})
public class SoapInstanceNotFoundExceptionBean {
     ...
     * 
     * @return
     *     returns SoapInstanceNotFoundExceptionInfo
     */
     ...
     */
    public void setFaultInfo(SoapInstanceNotFoundExceptionInfo faultInfo) {
