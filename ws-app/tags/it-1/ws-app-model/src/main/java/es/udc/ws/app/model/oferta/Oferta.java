...
public class Oferta {
    ...
    public Oferta(String des, Calendar dini, Calendar dfin,
    		Calendar ddis,float cosr,float cosd,int maxi, String nome){
    ...
    public Oferta(Long ofertaId, String descripcion,Calendar dataini,Calendar datafin,
    		Calendar dataDis, float costeR, float costeD, int maxi, String nomeO,
    		String estadO)
    {
    	this(descripcion,dataini,datafin,dataDis,costeR,costeD,maxi,nomeO);
